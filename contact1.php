...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Печатница Гущеряга предлага дизайн на рекламни и офис материали и висококачествен офсетов печат, на пълната гама от хартии, картони и пликове.Специфични фирмени формуляри от химизирана хартия със номерация и перфорация.">
        <meta name="author" content="">
        <meta name="keywords" content="Печатница, Печатница Гущеряга, печат, пликове, визитки, фактури, бланки, брошури, формуляри, картички, покани, дизайн, графичен дизайн, уеб дизайн, предпечат, календари, фирмени календари, офсетов печат, номерация, перфорация, флаери, листовки"/>
...
<p class="fax">
        <label>Fax</label>
        <input type="text" name="your_fax"<?php
// comment.php
if (!empty($_POST['fax'])) {
    // It's SPAM
}
